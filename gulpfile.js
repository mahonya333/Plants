...
function imgCompress() {
    return src("assets/img/**/*")
        ...
        .pipe(dest("plants/img"));
}

function cleanPlantsFolder() {
    return del("plants");
}

function fonts() {
    return src("assets/fonts/**/*").pipe(dest("plants/fonts"));
}
...
exports.cleanPlantslFolder = cleanPlantsFolder;
